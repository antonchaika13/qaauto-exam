...
public class GoogleFirstSearchPage extends GoogleBasePage {
    ...
    private WebElement secondPageLink;
        ...
        public GoogleFirstSearchPage(WebDriver webDriver) {
            super(webDriver);
    ...
    public GoogleSecondSearchPage clickOnSecondPage() {
